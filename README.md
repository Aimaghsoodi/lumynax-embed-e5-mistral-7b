...
[🤗 Weights & model card on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-embed-e5-mistral-7b) · [abteex.com](https://abteex.com) · [lumynax.com](https://lumynax.com) · [Monorepo](https://github.com/Aimaghsoodi/lumynax-release)

---

This GitHub repo mirrors the **runtime scaffolding** (quickstart, requirements, Modelfile, Space, docs). The model **weights** are published on Hugging Face at `AbteeXAILab/lumynax-embed-e5-mistral-7b` — they exceed GitHub's per-file limit.

```bash
hf download AbteeXAILab/lumynax-embed-e5-mistral-7b --local-dir lumynax-embed-e5-mistral-7b
cd lumynax-embed-e5-mistral-7b && pip install -r requirements.txt && python quickstart.py --interactive
# Or:  pip install lumynax && lumynax run lumynax-embed-e5-mistral-7b -i
```
